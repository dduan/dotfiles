...
export FZF_DEFAULT_COMMAND='/usr/local/bin/rg --files -S --no-ignore --hidden --follow --glob "!tags" --glob "!.git/*" --glob "!build/" --glob "!.build/" --glob "!.DS_Store" --glob "!build.noindex" --glob "!Pods" --glob "!deps"'
